...
// KaçNet uyarlaması: tipografi Hanken Grotesk / Source Sans 3 (Adobe seçimi),
// dev arka yazı KAÇNET, marquee sloganlarımız, gerçek mağaza bağlantıları.
const STYLES = `
.cinematic-footer-wrapper {
  ...
  --pill-shadow: color-mix(in oklch, var(--foreground) 18%, transparent);
  --pill-highlight: color-mix(in oklch, #ffffff 65%, transparent);
  --pill-inset-shadow: color-mix(in oklch, var(--foreground) 8%, transparent);
  ...
  --pill-shadow-hover: color-mix(in oklch, var(--foreground) 28%, transparent);
...
.footer-aurora {
  background: radial-gradient(
    circle at 50% 50%,
    color-mix(in oklch, var(--fosfor) 55%, transparent) 0%,
    color-mix(in oklch, var(--secondary) 22%, transparent) 45%,
    transparent 70%
  );
}
.footer-glass-pill {
  background: linear-gradient(145deg, var(--card) 0%, color-mix(in oklch, var(--card) 70%, var(--background)) 100%);
  box-shadow:
...
.footer-glass-pill:hover {
  ...
  box-shadow:
      0 20px 40px -12px var(--pill-shadow-hover),
...
.footer-giant-bg-text {
  ...
  color: transparent;
  -webkit-text-stroke: 1px color-mix(in oklch, var(--foreground) 14%, transparent);
  background: linear-gradient(180deg, color-mix(in oklch, var(--foreground) 16%, transparent) 0%, transparent 62%);
...
const MarqueeItem = () => (
  <div className="flex items-center space-x-12 px-6">
    <span>Gerçek Ölçüm</span> <span className="text-secondary/70">✦</span>
    <span>Sahte Rozet Yok</span> <span className="text-primary/50">✦</span>
    <span>120 Soru · 130 Dakika</span> <span className="text-secondary/70">✦</span>
    <span>Boş Bırakma Analizi</span> <span className="text-primary/50">✦</span>
    <span>Lisans · Önlisans · Ortaöğretim</span> <span className="text-secondary/70">✦</span>
  </div>
);
    ...
    <>
      ...
      >
        <footer className="fixed bottom-0 left-0 flex h-screen w-full flex-col justify-between overflow-hidden bg-background text-foreground cinematic-footer-wrapper">
          ...
          <div className="absolute top-12 left-0 w-full overflow-hidden border-y border-border/70 bg-card/70 backdrop-blur-md py-4 z-10 -rotate-2 scale-110 shadow-xl">
          ...
          <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-6 mt-20 w-full max-w-5xl mx-auto">
            ...
            <div ref={linksRef} className="flex flex-col items-center gap-6 w-full">
              ...
              <div className="flex flex-wrap justify-center gap-3 md:gap-6 w-full mt-2">
                <MagneticButton as="a" href="/fiyatlar.html" className="footer-glass-pill px-6 py-3 rounded-full text-muted-foreground font-medium text-xs md:text-sm hover:text-foreground">
                  Fiyatlar
                </MagneticButton>
          ...
          <div className="relative z-20 w-full pb-8 px-6 md:px-12 flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="footer-glass-pill px-6 py-3 rounded-full flex items-center gap-2 order-1 md:order-2 cursor-default border-border/50">
              <span className="text-muted-foreground text-[10px] md:text-xs font-bold uppercase tracking-widest">Sahte rozet yok</span>
              <span className="animate-footer-heartbeat text-sm md:text-base text-destructive">❤</span>
              <span className="text-muted-foreground text-[10px] md:text-xs font-bold uppercase tracking-widest">gerçek ölçüm var</span>
            </div>
